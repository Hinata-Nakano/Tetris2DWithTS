...
// テトリミノを下に移動させる関数
export function moveDown(width: number, currentTetromino: number[], currentPosition: number, cells: HTMLElement[]):{ position: number, tetromino: number[], gameOver: boolean } {
